...
export default function Collapse(props) {
	const [toggle, setToggle] = useState(false); // je définis le state du toggle (et false par défaut)
	const [heightEl, setHeightEl] = useState(); // je définis le state de la hauteur du collapse
